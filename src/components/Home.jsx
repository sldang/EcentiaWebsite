        ...
        items-center justify-center h-full px-4 md:flex-row">
            <div className="flex flex-col justify-center h-full">
                <h2 className="text-4xl sm:text-7xl font-bold text-white">
                    Our company specializes in Full Stack Applications
                </h2>
                <p className="text-gray-500 py-4 max-w-md">
                    We have plenty of years of experience building and designing 
                    full stack applications. Currently, we are using technologies 
            ...
            <div>
                <img src={HeroImage} alt="Our stock profile" 
